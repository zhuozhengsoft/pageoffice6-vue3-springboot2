	...
	import axios from 'axios';
	  export default{
	    ...
	    created: function(){
	      ...
	      axios.post("/api/word/InsertPageBreak2/Word").then((response) => {
	    ...
	    methods:{
            ...
            Save() {
                ...
                if (pageofficectrl.CustomSaveResult == "ok") {
                    alert("保存成功！请在pageoffice6-springboot2-back/static/doc/word/InsertPageBreak2目录下查看合并后的新文档\"test3.doc\"。");
                }
            } 
	    },
	    mounted: function(){
