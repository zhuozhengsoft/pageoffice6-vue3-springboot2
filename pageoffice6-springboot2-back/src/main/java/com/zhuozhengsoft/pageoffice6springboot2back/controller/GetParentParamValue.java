 ...
 */
@RestController
@RequestMapping(value = "/basic/GetParentParamValue")
public class GetParentParamValue {
    ...
    public String word(HttpServletRequest request) {
         ...
         */
        poCtrl.webOpen("/doc/basic/GetParentParamValue/test.docx", OpenModeType.docNormalEdit, "张三");
