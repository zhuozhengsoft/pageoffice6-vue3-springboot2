 ...
 */
@RestController
@RequestMapping(value = "/basic/CallParentFunction")
public class CallParentFunction {
    ...
    public String word(HttpServletRequest request) {
         ...
         */
        poCtrl.webOpen("/doc/basic/CallParentFunction/test.docx", OpenModeType.docNormalEdit, "张三");
