 ...
 */
@RestController
@RequestMapping(value = "/basic/OpenOssDoc")
public class OpenOssDoc {
    ...
    public String word(HttpServletRequest request) {
         ...
         */
        poCtrl.webOpen("Openstream", OpenModeType.docNormalEdit, "张三");
        return  poCtrl.getHtmlCode();
    }

    @RequestMapping(value = "OpenOssDoc/Openstream")
