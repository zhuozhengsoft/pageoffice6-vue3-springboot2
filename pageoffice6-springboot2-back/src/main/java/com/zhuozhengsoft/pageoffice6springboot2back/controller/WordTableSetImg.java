...
@RestController
@RequestMapping(value = "/word/WordTableSetImg")
public class WordTableSetImg {
    ...
    public String showWord(HttpServletRequest request) {
        ...
        table1.openCellRC(1, 1).setValue("[image]/doc/word/WordTableSetImg/wang.gif[/image]");
         ...
         */
        poCtrl.webOpen("/doc/word/WordTableSetImg/test.docx", OpenModeType.docNormalEdit, "张三");
