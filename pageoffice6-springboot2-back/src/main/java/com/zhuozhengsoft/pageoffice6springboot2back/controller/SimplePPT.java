 ...
 */
@RestController
@RequestMapping(value = "/ppt/SimplePPT")
public class SimplePPT {
    ...
    public String ppt(HttpServletRequest request) {
         ...
         */
        poCtrl.webOpen("/doc/ppt/SimplePPT/test.pptx", OpenModeType.pptNormalEdit, "张三");
        return  poCtrl.getHtmlCode();
    }
    @RequestMapping("/save")
    public void save(HttpServletRequest request, HttpServletResponse response) {
        FileSaver fs = new FileSaver(request, response);
        fs.saveToFile(dir + "ppt/SimplePPT/" + fs.getFileName());
        fs.close();
    }
