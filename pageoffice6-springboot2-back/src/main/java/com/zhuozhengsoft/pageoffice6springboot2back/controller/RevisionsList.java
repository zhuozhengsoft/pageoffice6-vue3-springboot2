...
@RestController
@RequestMapping(value = "/word/RevisionsList")
public class RevisionsList {
    ...
    public String showWord(HttpServletRequest request) {
        ...
        //设置保存页面
        poCtrl.setSaveFilePage("/word/RevisionsList/save");//设置处理文件保存的请求方法
         /**
         ...
         */
        poCtrl.webOpen("/doc/word/RevisionsList/test.docx", OpenModeType.docRevisionOnly, "张三");
    ...
    public void save(HttpServletRequest request, HttpServletResponse response) {
        ...
        fs.saveToFile(dir + "word/RevisionsList/" + fs.getFileName());
        fs.close();
    }
