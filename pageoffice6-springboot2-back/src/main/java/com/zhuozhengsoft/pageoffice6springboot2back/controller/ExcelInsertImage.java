 ...
 */
@RestController
@RequestMapping(value = "/excel/ExcelInsertImage")
public class ExcelInsertImage {
    ...
    public String word(HttpServletRequest request) {
        ...
        sheet.openCell("A1").setValue("[image]/doc/excel/ExcelInsertImage/logo.jpg[/image]");
         ...
         */
        poCtrl.webOpen("/doc/excel/ExcelInsertImage/test.xlsx", OpenModeType.xlsNormalEdit, "张三");
