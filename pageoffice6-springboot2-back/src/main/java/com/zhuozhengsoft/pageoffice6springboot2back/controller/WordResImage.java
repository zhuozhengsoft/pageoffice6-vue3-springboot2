...
public class WordResImage {
    ...
    public String showWord(HttpServletRequest request) {
        ...
        data2.setValue("[word]/doc/word/WordResImage/2.docx[/word]");
        DataRegion data3 = worddoc.openDataRegion("PO_p3");
        data3.setValue("[word]/doc/word/WordResImage/3.docx[/word]");
         ...
         */
        poCtrl.webOpen("/doc/word/WordResImage/test.docx", OpenModeType.docNormalEdit, "张三");
