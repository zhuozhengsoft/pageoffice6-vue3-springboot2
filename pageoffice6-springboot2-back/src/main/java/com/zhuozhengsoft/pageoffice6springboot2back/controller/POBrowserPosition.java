 ...
 */
@RestController
@RequestMapping(value = "/basic/POBrowserPosition")
public class POBrowserPosition {
    ...
    public String word(HttpServletRequest request) {
         ...
         */
        poCtrl.webOpen("/doc/basic/POBrowserPosition/test.docx", OpenModeType.docNormalEdit, "张三");
