...
@RestController
@RequestMapping(value = "/word/DisableCopyOut")
public class DisableCopyOutController {
    ...
    public String showWord(HttpServletRequest request) {
        ...
        // 设置保存文件的接口地址
        poCtrl.setSaveFilePage("/word/DisableCopyOut/save");
         /**
         ...
         */
        poCtrl.webOpen("/doc/word/DisableCopyOut/test.docx", OpenModeType.docNormalEdit, "张三");
    ...
    public void save(HttpServletRequest request, HttpServletResponse response) {
        ...
        fs.saveToFile(dir + "word/DisableCopyOut/" + fs.getFileName());
        fs.close();
    }
