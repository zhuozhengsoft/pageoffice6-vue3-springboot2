 ...
 */
@RestController
@RequestMapping(value = "/basic/HideOfficeToolbar")
public class HideOfficeToolbar {
    ...
    public String word(HttpServletRequest request) {
         ...
         */
        poCtrl.webOpen("/doc/basic/HideOfficeToolbar/template.docx", OpenModeType.docNormalEdit, "张三");
