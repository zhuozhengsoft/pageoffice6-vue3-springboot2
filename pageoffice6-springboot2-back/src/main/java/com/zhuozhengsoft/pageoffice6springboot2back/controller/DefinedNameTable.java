 ...
 */
@RestController
@RequestMapping(value = "/excel/DefinedNameTable")
public class DefinedNameTable {
    ...
    public String word(HttpServletRequest request) {
         ...
         */
        poCtrl.webOpen("/doc/excel/DefinedNameTable/test.xlsx", OpenModeType.xlsNormalEdit, "张三");
