 ...
 */
@RestController
@RequestMapping(value = "/basic/HideCustomToolbar")
public class HideCustomToolbar {
    ...
    public String word(HttpServletRequest request) {
         ...
         */
        poCtrl.webOpen("/doc/basic/HideCustomToolbar/template.docx", OpenModeType.docNormalEdit, "张三");
