...
public class WordResExcel {
    ...
    public String showWord(HttpServletRequest request) {
        ...
        data1.setValue("[excel]/doc/word/WordResExcel/1.xls[/excel]");
        DataRegion data2 = worddoc.openDataRegion("PO_p2");
        data2.setValue("[word]/doc/word/WordResExcel/2.doc[/word]");
        DataRegion data3 = worddoc.openDataRegion("PO_p3");
        data3.setValue("[word]/doc/word/WordResExcel/3.doc[/word]");
         ...
         */
        poCtrl.webOpen("/doc/word/WordResExcel/test.doc", OpenModeType.docNormalEdit, "张三");
