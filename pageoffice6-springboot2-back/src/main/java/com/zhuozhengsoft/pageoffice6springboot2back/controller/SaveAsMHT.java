 ...
 */
@RestController
@RequestMapping(value = "/basic/SaveAsMHT")
public class SaveAsMHT {
    ...
    public String word(HttpServletRequest request) {
         ...
         */
        poCtrl.webOpen("/doc/basic/SaveAsMHT/test.docx", OpenModeType.docNormalEdit, "张三");
        return  poCtrl.getHtmlCode();
    }
    @RequestMapping("/save")
    public void save(HttpServletRequest request, HttpServletResponse response) {
        FileSaver fs = new FileSaver(request, response);
        fs.saveToFile(dir + "basic/SaveAsMHT/" + fs.getFileName());
        fs.close();
    }
